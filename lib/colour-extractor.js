...
(function() {
  ...
  sortByFrequency = function(arg, arg1) {
    var _a2, _b2, a, b;
    a = arg[0], _a2 = arg[1];
    b = arg1[0], _b2 = arg1[1];
    if (a > b) {
  ...
  distance = function(arg, arg1) {
    ...
    r1 = arg[0], g1 = arg[1], b1 = arg[2];
    r2 = arg1[0], g2 = arg1[1], b2 = arg1[2];
  ...
  reduceSimilar = function(xs, r) {
    var N, avgD, d, i, len, maxD, maxF, minD, n, rs, tds, x;
    minD = 2e308;
    maxD = 0;
    maxF = 0;
    n = 0;
